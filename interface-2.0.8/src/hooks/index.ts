...
import IDreamswapV1Factory from '../constants/abis/v1_factory.json'
...
export function useV1FactoryContract(): Contract | null {
  return useContract(V1_FACTORY_ADDRESS, IDreamswapV1Factory, false)
}
...
export function usePairContract(pairAddress?: string, withSignerIfPossible = true): Contract | null {
  return useContract(pairAddress, IDreamswapV2PairABI, withSignerIfPossible)
}
