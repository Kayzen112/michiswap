...
import { abi as IDreamswapV2PairABI } from '@uniswap/v2-core/build/IDreamswapV2Pair.json'
import { abi as IDreamswapV2Router01ABI } from '@uniswap/v2-periphery/build/IDreamswapV2Router01.json'
...
export function getRouterContract(chainId: number, library: Web3Provider, account?: string) {
  return getContract(ROUTER_ADDRESS, IDreamswapV2Router01ABI, library, account)
}

// account is optional
export function getExchangeContract(pairAddress: string, library: Web3Provider, account?: string) {
  return getContract(pairAddress, IDreamswapV2PairABI, library, account)
}
